...
@section('content')
<div class="max-w-3xl mx-auto mt-10 bg-white p-6 rounded-2xl shadow-md border border-blue-200">
    <h2 class="text-2xl font-bold text-blue-600 mb-4">Step 4: Days & Activities</h2>

    <form action="{{ route('trips.store.final') }}" method="POST">
        @csrf
